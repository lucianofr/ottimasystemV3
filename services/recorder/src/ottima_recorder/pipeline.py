...
# Uma linha por EXECUÇÃO do SSTO (ADR-026 §11), não por variável: no pior caso (Ts_mpc de
...
class RecorderPipeline:
    ...
    async def flush(self) -> None:
        ...
        Auditoria tem prioridade (spec §6.3) — e o registro do SSTO (ADR-026 §11) é
    ...
    def _ingest_ssto_run(self, flow_id: int, block_id: str, state: MpcState) -> None:
        """Enfileira o registro de auditoria do SSTO, quando o quadro traz um (ADR-026 §11).
