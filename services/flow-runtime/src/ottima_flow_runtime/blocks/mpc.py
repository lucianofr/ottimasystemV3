...
class MpcBlock(Block):
    ...
    def reset(self) -> None:
        ...
        self._input_ok = True
        # Registro do SSTO à espera de publicação (ADR-026 §11): preenchido ao aplicar o
    ...
    async def _absorver_ssto(self, run: SstoRun | None) -> None:
        ...
        quando ela não fechou (ADR-026 §10/§11).
    ...
    def _build_state(self, ts: datetime) -> MpcState:
        ...
        # resultado que o produziu (ADR-026 §11). Publicações imediatas (mudança de modo,
