"""Mesa de casos dos backends de solver do SSTO (ADR-026 §7).
...
def test_custo_negativo_leva_a_variavel_ao_limite_superior():
    """Preço negativo = maximizar (ADR-026 §9): a solução vai ao limite SUPERIOR."""
...
def test_highs_recusa_termo_quadratico():
    """LP não resolve QP: o detuning (ADR-026 §8) exige backend QP — falhar alto é melhor
