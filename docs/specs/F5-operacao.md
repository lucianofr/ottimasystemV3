...
| A-11 | O que o trend de operação mostra por default | **CVs (PV+SP) ligadas até o teto de 8 penas; MVs opt-in** pela legenda; janela default 30 min (15 min/30 min/2 h/8 h) |
