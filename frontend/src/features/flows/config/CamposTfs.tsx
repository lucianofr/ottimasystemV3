...
/**
 * Matriz 2x2 (spec F3 §3.4): `matrix[J][K]` é a contribuição de `uK` para `yJ`.
 *
 * `enabled` e `kind` são estado do modal; os params são campos não-controlados lidos no
 * envio (`matrizDoFormulario`). Trocar o modelo remonta os campos com os padrões do novo
 * `kind`, e é assim que nenhum parâmetro do modelo antigo sobrevive dentro de `data`.
 */
